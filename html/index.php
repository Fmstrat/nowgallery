...
<div id="fullscreen">
	...
	<div id="screen-image-0" class="screen-image page nodisplay">
		<div class="image-header"><div class="leftbutton"><img src="images/back.png" width=50 height=50 onclick="window.history.back();scrollBack();"></div><div class="rightbutton"><img src="images/download.png" width=50 height=50 onclick="downloadImage()"></div><div id="img-title-0" class="title"></div></div>
	...
	<div id="screen-image-1" class="screen-image page nodisplay">
		<div class="image-header"><div class="leftbutton"><img src="images/back.png" width=50 height=50 onclick="window.history.back();scrollBack();"></div><div class="rightbutton"><img src="images/download.png" width=50 height=50 onclick="downloadImage()"></div><div id="img-title-1" class="title"></div></div>
	...
	<div id="screen-image-2" class="screen-image page nodisplay">
		<div class="image-header"><div class="leftbutton"><img src="images/back.png" width=50 height=50 onclick="window.history.back();scrollBack();"></div><div class="rightbutton"><img src="images/download.png" width=50 height=50 onclick="downloadImage()"></div><div id="img-title-2" class="title"></div></div>
	...
	<div id="screen-image-3" class="screen-image page nodisplay">
		<div class="image-header"><div class="leftbutton"><img src="images/back.png" width=50 height=50 onclick="window.history.back();scrollBack();"></div><div class="rightbutton"><img src="images/download.png" width=50 height=50 onclick="downloadImage()"></div><div id="img-title-3" class="title"></div></div>
	...
	<div id="screen-image-4" class="screen-image page nodisplay">
		<div class="image-header"><div class="leftbutton"><img src="images/back.png" width=50 height=50 onclick="window.history.back();scrollBack();"></div><div class="rightbutton"><img src="images/download.png" width=50 height=50 onclick="downloadImage()"></div><div id="img-title-4" class="title"></div></div>
